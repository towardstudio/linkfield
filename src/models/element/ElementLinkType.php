...
namespace towardstudio\linkfield\models\element;

use Craft;
use craft\base\ElementInterface;
use craft\errors\SiteNotFoundException;
use towardstudio\linkfield\fields\LinkField;
use towardstudio\linkfield\listeners\ElementListener;
...
class ElementLinkType extends LinkType
{
  ...
  protected function getQueryField(Link $value): ?array {
    ...
    return [
      ...
      'name'  => 'customQuery',
      'value' => $queryValue,
      'placeholder' => Craft::t('linkfield', 'Query, starts with "#" or "?"'),
    ];
  }
