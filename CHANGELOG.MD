...
- Changed: The php namespace of the plugin has been changed from `linkfield` to `towardstudio\linkfield`
- Changed: Link types now use a common base class `towardstudio\linkfield\models\LinkType`
